...
expression, and an updated mapping of code variables to type variables.  The
logic as to which constraints are deduced is covered in section
\ref{sec:constraint-generation-rules}.
